...
while(True):
    try: 
        ...
        ##like drawing a box in the centre of the video
        ...
        ##to only consider the area inside the box for detecting the alphabets
        ...
        #convert to gray scaled image , L format means each pixel is represented by a single value
